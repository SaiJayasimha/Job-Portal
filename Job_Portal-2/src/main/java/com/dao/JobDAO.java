...
public class JobDAO {
	...
	// Method to fetch jobs by category OR location
	public List<Jobs> getJobsORLocationAndCate(String category, String location) {
	    List<Jobs> list = new ArrayList<>();
	    Jobs j = null;

	    try {
	        // SQL query to fetch jobs based on category or location
	...
	// Method to fetch jobs by category AND location
	public List<Jobs> getJobsAndLocationAndCate(String category, String location) {
	    List<Jobs> list = new ArrayList<>();
	    Jobs j = null;

	    try {
	        // SQL query to fetch jobs based on both category and location
